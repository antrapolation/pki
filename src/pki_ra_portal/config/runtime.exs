...
#
#     PHX_SERVER=true bin/pki_ra_portal start
#
...
config :pki_ra_portal, PkiRaPortalWeb.Endpoint,
  http: [port: String.to_integer(System.get_env("RA_PORTAL_PORT", System.get_env("PORT", "4004")))]
...
# In direct mode, RA engine runs in-process and needs its repos configured
...
# AuditTrail Repo — audit_events table lives in the CA engine database
