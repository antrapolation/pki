defmodule PkiRaPortalWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :pki_ra_portal
  ...
  @session_options [
    ...
    encryption_salt: Application.compile_env(:pki_ra_portal, :encryption_salt, "pki_ra_enc"),
    same_site: "Lax",
  ...
  plug Plug.Static,
    ...
    only: PkiRaPortalWeb.static_paths(),
