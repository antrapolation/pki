\restrict VIVmbsMGL5ddlwHI53X7lQ7zvAf22cnZ8rrNj9XRd5Q8e29oMNKaDGd3O5CrbfP
...
CREATE TABLE public.ca_instances (
    id uuid NOT NULL,
...
CREATE TABLE public.key_ceremonies (
    id uuid NOT NULL,
    ca_instance_id uuid NOT NULL,
    issuer_key_id uuid,
...
CREATE TABLE public.keypair_access (
    id uuid NOT NULL,
    issuer_key_id uuid NOT NULL,
    user_id uuid NOT NULL,
    granted_by uuid,
...
CREATE TABLE public.keypair_grants (
    id uuid NOT NULL,
...
CREATE TABLE public.managed_keypairs (
    id uuid NOT NULL,
    name character varying(255) NOT NULL,
    algorithm character varying(255) NOT NULL,
...
CREATE TABLE public.threshold_shares (
    id uuid NOT NULL,
    issuer_key_id uuid NOT NULL,
...
CREATE INDEX audit_events_actor_did_index ON public.audit_events USING btree (actor_did);
CREATE INDEX audit_events_ca_instance_id_index ON public.audit_events USING btree (ca_instance_id);
CREATE UNIQUE INDEX audit_events_event_id_index ON public.audit_events USING btree (event_id);
CREATE INDEX audit_events_resource_type_resource_id_index ON public.audit_events USING btree (resource_type, resource_id);
CREATE INDEX audit_events_timestamp_index ON public.audit_events USING btree ("timestamp");
CREATE UNIQUE INDEX ca_instances_name_index ON public.ca_instances USING btree (name);
CREATE INDEX ca_instances_parent_id_index ON public.ca_instances USING btree (parent_id);
CREATE INDEX ca_users_ca_instance_id_index ON public.ca_users USING btree (ca_instance_id);
CREATE INDEX ca_users_role_index ON public.ca_users USING btree (role);
CREATE INDEX ca_users_status_index ON public.ca_users USING btree (status);
CREATE UNIQUE INDEX ca_users_username_index ON public.ca_users USING btree (username);
...
CREATE INDEX issued_certificates_issuer_key_id_index ON public.issued_certificates USING btree (issuer_key_id);
CREATE INDEX issued_certificates_issuer_key_id_status_index ON public.issued_certificates USING btree (issuer_key_id, status);
CREATE INDEX issued_certificates_not_after_index ON public.issued_certificates USING btree (not_after);
CREATE UNIQUE INDEX issued_certificates_serial_number_index ON public.issued_certificates USING btree (serial_number);
CREATE INDEX issued_certificates_status_index ON public.issued_certificates USING btree (status);
CREATE INDEX issuer_keys_ca_instance_id_index ON public.issuer_keys USING btree (ca_instance_id);
CREATE UNIQUE INDEX issuer_keys_ca_instance_id_key_alias_index ON public.issuer_keys USING btree (ca_instance_id, key_alias);
CREATE INDEX issuer_keys_ca_instance_id_status_index ON public.issuer_keys USING btree (ca_instance_id, status);
CREATE INDEX issuer_keys_status_index ON public.issuer_keys USING btree (status);
CREATE INDEX key_ceremonies_ca_instance_id_index ON public.key_ceremonies USING btree (ca_instance_id);
CREATE INDEX key_ceremonies_issuer_key_id_index ON public.key_ceremonies USING btree (issuer_key_id);
CREATE UNIQUE INDEX keypair_access_issuer_key_id_user_id_index ON public.keypair_access USING btree (issuer_key_id, user_id);
CREATE INDEX keypair_access_user_id_index ON public.keypair_access USING btree (user_id);
CREATE INDEX keypair_grants_credential_id_index ON public.keypair_grants USING btree (credential_id);
CREATE UNIQUE INDEX keypair_grants_managed_keypair_id_credential_id_index ON public.keypair_grants USING btree (managed_keypair_id, credential_id);
CREATE INDEX keystores_ca_instance_id_index ON public.keystores USING btree (ca_instance_id);
CREATE INDEX managed_keypairs_ca_instance_id_index ON public.managed_keypairs USING btree (ca_instance_id);
CREATE UNIQUE INDEX managed_keypairs_ca_instance_id_name_index ON public.managed_keypairs USING btree (ca_instance_id, name);
CREATE INDEX managed_keypairs_status_index ON public.managed_keypairs USING btree (status);
CREATE UNIQUE INDEX threshold_shares_issuer_key_id_custodian_user_id_index ON public.threshold_shares USING btree (issuer_key_id, custodian_user_id);
CREATE INDEX threshold_shares_issuer_key_id_index ON public.threshold_shares USING btree (issuer_key_id);
ALTER TABLE ONLY public.ca_instances
...
\unrestrict VIVmbsMGL5ddlwHI53X7lQ7zvAf22cnZ8rrNj9XRd5Q8e29oMNKaDGd3O5CrbfP
