...
ALTER TABLE ONLY public.cert_profiles
...
ALTER TABLE ONLY public.ra_api_keys
    ADD CONSTRAINT ra_api_keys_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.ra_instances
...
ALTER TABLE ONLY public.cert_profiles
    ADD CONSTRAINT cert_profiles_ra_instance_id_fkey FOREIGN KEY (ra_instance_id) REFERENCES public.ra_instances(id) ON DELETE SET NULL;
ALTER TABLE ONLY public.credentials
    ADD CONSTRAINT credentials_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.ra_users(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.csr_requests
    ADD CONSTRAINT csr_requests_cert_profile_id_fkey FOREIGN KEY (cert_profile_id) REFERENCES public.cert_profiles(id) ON DELETE RESTRICT;
ALTER TABLE ONLY public.csr_requests
    ADD CONSTRAINT csr_requests_reviewed_by_fkey FOREIGN KEY (reviewed_by) REFERENCES public.ra_users(id) ON DELETE SET NULL;
ALTER TABLE ONLY public.ra_api_keys
    ADD CONSTRAINT ra_api_keys_ra_instance_id_fkey FOREIGN KEY (ra_instance_id) REFERENCES public.ra_instances(id) ON DELETE SET NULL;
ALTER TABLE ONLY public.ra_api_keys
