defmodule PkiPlatformEngine.EmailTemplates do
  ...
  def single_admin_credential(tenant_name, role_label, portal_url, username, password) do
    """
    <!DOCTYPE html>
    <html>
    <head><meta charset="utf-8"></head>
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px; color: #1a1a2e;">
      ...
      <p style="font-size: 15px; margin-bottom: 24px;">The <strong>#{role_label}</strong> credentials for tenant <strong>#{tenant_name}</strong> have been reset.</p>
      ...
      <div style="background: #f8f9fa; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
        <h2 style="font-size: 14px; font-weight: 600; color: #661ae6; margin: 0 0 12px; text-transform: uppercase; letter-spacing: 1px;">#{role_label}</h2>
        <table style="width: 100%; font-size: 14px;">
