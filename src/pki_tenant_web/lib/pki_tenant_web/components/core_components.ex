defmodule PkiTenantWeb.CoreComponents do
  @moduledoc """
  Provides core UI components for the tenant web portal.

  Shared by both CA and RA layouts. Built on Tailwind CSS + daisyUI.
  """
  use Phoenix.Component
  use Gettext, backend: PkiTenantWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    if count = opts[:count] do
      Gettext.dngettext(PkiTenantWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PkiTenantWeb.Gettext, "errors", msg, opts)
    end
  end
