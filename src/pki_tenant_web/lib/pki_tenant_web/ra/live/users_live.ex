defmodule PkiTenantWeb.Ra.UsersLive do
  @moduledoc "RA portal user management. Delegates to `PkiTenantWeb.UsersLiveShared`."
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok, assign(socket, UsersLiveShared.initial_assigns(:ra, "ra_admin"))}
  end
