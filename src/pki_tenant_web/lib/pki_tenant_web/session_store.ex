defmodule PkiTenantWeb.SessionStore do
  @moduledoc """
  ETS-backed server-side session registry for the per-tenant BEAM.
  ...
  @table :pki_tenant_session_store
  @sweep_interval_ms 5 * 60 * 1000
  @pubsub PkiTenantWeb.PubSub
  ...
  def handle_info(:sweep, state) do
    timeout_ms = Application.get_env(:pki_tenant_web, :session_idle_timeout_ms, 30 * 60 * 1000)
    count = do_sweep(timeout_ms)
