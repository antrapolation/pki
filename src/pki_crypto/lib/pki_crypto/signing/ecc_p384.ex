defmodule PkiCrypto.Signing.ECCP384 do
  @moduledoc "ECC P-384 (secp384r1) signing algorithm using SHA-384."
  defstruct []
end

defimpl PkiCrypto.Algorithm, for: PkiCrypto.Signing.ECCP384 do
  @curve :secp384r1
  @hash :sha384
  ...
  def identifier(_algo), do: "ECC-P384"
