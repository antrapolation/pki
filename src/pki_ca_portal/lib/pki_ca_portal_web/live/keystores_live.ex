            ...
            <table class="table table-sm table-fixed w-full">
              <thead>
                <tr class="text-xs uppercase text-base-content/50">
                  <th class="w-[25%]">CA Instance</th>
                  <th class="w-[10%]">Type</th>
                  <th class="w-[22%]">HSM Device</th>
              ...
              <tbody id="keystore-list">
                ...
                <tr :for={ks <- decoded_keystores} id={"keystore-#{ks.id}"} class="hover">
                  <td class="font-medium text-sm overflow-hidden text-ellipsis whitespace-nowrap">{Map.get(ks, :ca_instance_name, "-")}</td>
                  <td>
