defmodule EccTest do
  ...
  test "Full operation via protocol API" do
    assert {:ok, skeypair} = KeyGenerator.generate_keypair(SoftKeyGeneratorSpec.new(:ecc, :p256))
    ...
    root_co =
      %CertOwner{}
      |> CertOwner.set_name("Soft Private Keystore Cert Test")
