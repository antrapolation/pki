defmodule MlKemTest do
  ...
  test "ML-KEM full operation via protocol API" do
    var = ContextConfig.get(%MlKemKeypair{}, :supported_variant)

    Enum.each(var, fn v ->
      assert {:ok, skeypair} =
               KeyGenerator.generate_keypair(SoftKeyGeneratorSpec.new(:ml_kem, v))
      ...
      # root_co =
      #  %CertOwner{}
      #  |> CertOwner.set_name("Soft ML-DSA Private Keystore Cert Test")
      ...
      # File.write!("ml_kem_root.cer", root_cert)
