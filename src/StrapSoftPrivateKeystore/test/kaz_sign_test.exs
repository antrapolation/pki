defmodule KazSignTest do
  ...
  test "KAZ-SIGN full operation via protocol API" do
    var = ContextConfig.get(%KazSignKeypair{}, :supported_variant)

    Enum.each(var, fn v ->
      assert {:ok, skeypair} =
               KeyGenerator.generate_keypair(SoftKeyGeneratorSpec.new(:kaz_sign, v))
      ...
      root_co =
        %CertOwner{}
        |> CertOwner.set_name("Soft KAZ-SIGN Private Keystore Cert Test")
      ...
      File.write!("kaz_sign_root.cer", root_cert)
