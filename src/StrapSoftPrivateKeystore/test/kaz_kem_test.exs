defmodule KazKemTest do
  ...
  test "ML-KEM full operation via protocol API" do
    var = ContextConfig.get(%KazKemKeypair{}, :supported_variant)

    Enum.each(var, fn v ->
      assert {:ok, skeypair} =
               KeyGenerator.generate_keypair(SoftKeyGeneratorSpec.new(:kaz_kem, v))
      ...
      # File.write!("kaz_kem_root.cer", root_cert)
