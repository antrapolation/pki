defmodule MlDsaTest do
  ...
  test "ML-DSA full operation via protocol API" do
    var = ContextConfig.get(%MlDsaKeypair{}, :supported_variant)

    Enum.each(var, fn v ->
      assert {:ok, skeypair} =
               KeyGenerator.generate_keypair(SoftKeyGeneratorSpec.new(:ml_dsa, v))
      ...
      File.write!("ml_dsa_root.cer", root_cert)
